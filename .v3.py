...
def helpnote():
	...
	exit(" [*] TELEGRAM: https://t.me/techhelpzone")
...
def notice():
	...
	runtxt("\033[0;93m  SENT THIS KEY TO ADMIN FOR \033[0;96m FREE APPROVAL>> %s%s"%(G,basesplit))
	runtxt("\033[0;92m ADMIN TELEGRAM 🔰🥰 https://t.me/EsanAhmedAbir")
...
##########Menuuu
		...
		print("%s [%s10%s]%s Main Menu %s(MultiTool)"%(R,G,R,Y,G))
		print(GET)
		hoga = input("\n%s [?] CHOICE : "%(B))
		if hoga in ["", " "]:
			Main()
...
##########menu
	def menu(self):
		if	os.path.isfile('multi.py'):
			os.system("pkg install wget -y")
			os.system("pip install requests && pip install bs4 && clear && wget https://raw.githubusercontent.com/EsanAhmedAbir/MultiTool/main/multi.py && clear && python multi.py")

		else:
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/EsanAhmedAbir/MultiTool/main/multi.py && clear && python multi.py")
