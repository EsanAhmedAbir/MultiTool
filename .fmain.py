...
##########Menuuu
		...
		print("%s [%s4%s]%s Main Menu %s"%(G,R,G,Y,B))
		print("%s [%s5%s]%s Exit %s"%(G,R,G,Y,B))
...
##########make file
	def make(self):
		if	os.path.isfile('.make.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://raw.githubusercontent.com/EsanAhmedAbir/MultiTool/main/.make.py && clear && python2 .make.py")
